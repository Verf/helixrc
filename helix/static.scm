...
(provide extend_to_file_start)
;;@doc
;;Extend to line number<n> else file start
(define (extend_to_file_start)
    (helix.static.extend_to_file_start *helix.cx*))

(provide extend_to_file_end)
;;@doc
;;Extend to file end
(define (extend_to_file_end)
    (helix.static.extend_to_file_end *helix.cx*))
...
(provide extend_to_last_line)
;;@doc
;;Extend to last line
(define (extend_to_last_line)
    (helix.static.extend_to_last_line *helix.cx*))
